...
public class QuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null){
            ...
            questionModelList = quizDBHelper.getAllQuestions();
        ...
        confirmNextButton.setOnClickListener(v -> {
            if(!answered){
                if(radioOne.isChecked() || radioTwo.isChecked() || radioThree.isChecked() || radioFour.isChecked() || radioFive.isChecked() || radioSix.isChecked()){
                    checkAnswer();
                    //saveAnswer();
                } else {
...
//    }
    ...
    private void showNextQuestion(){
        ...
        if (questionCounter < questionCountTotal) {
            ...
            questionCounter++;
            questCountText.setText("Question: " + questionCounter + " out of" + questionCountTotal);
            answered = false;
